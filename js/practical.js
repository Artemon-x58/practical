...
// const nameUser = prompt('укажи имя');
// const emailUser = prompt('электронная почта');
// const phoneUser = prompt('телефон');

// console.log (`КОРИСТУВАЧ ${nameUser} ВИКОРИСТОВУЄ  ${emailUser}  ПОЧТУ І ${phoneUser}  ТЕЛЕФОН`)
